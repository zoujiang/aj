			...
			var check = function(){
			    ...
			    if(img.width>0 || img.height>0){
			      	...
			      	if(h/w > div_h/div_w ){
			      		...
			      		html += "<div style='width:303px;height:303px;float:left;margin:10px;border:1px solid #000;' align='center'><img id='IMG_"+imgIndex+"' src='"+url+"' style='height:"+ div_h+"px;'/></div>";
			      	}else{
			      		html += "<div style='width:303px;height:303px;float:left;margin:10px;border:1px solid #000;line-height:300px;' align='center'><img id='IMG_"+imgIndex+"' src='"+url +"' style='width:"+ div_w+"px;'/></div>";
			      	}
			      	$("#imgview").append(html)
