...
public class ShopPayAbleAction extends FtpImgDownUploadAction {
	...
	public String add(String id ,String accountZFB, String secretZFB,String accountWX, String secretWX, String payTypeAndroidZFB, String payTypeAndroidWX, String payTypeIOSZFB, String payTypeIOSWX, 
			String Android_zfb,String Android_zfb_v, String Android_wx, String Android_wx_v, String IOS_zfb, String IOS_zfb_v, String IOS_wx, String IOS_wx_v, String serviceAmount ) {
		...
		try {
			Double.parseDouble(serviceAmount.trim());
		} catch (NumberFormatException e) {
			modelMap.put("success", false);
			modelMap.put("message", msg+"失败,年服务费格式错误，只能为数字");
			return modelMap.toString();
		}
		
		int i = shopPayAbleService.saveOrUpdate(id, accountZFB, secretZFB, accountWX, secretWX, payTypeAndroid, payTypeIOS, accessAndroidZFB, accessAndroidWX,accessIOSZFB, accessIOSWX, createTime, updateTime, serviceAmount);
