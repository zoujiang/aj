...
<head>
    ...
    function AppMgr(){
		...
		AppMgr.view = function(id,tpUrl, musicUrl,valid,e){
			...
			window.open (getProjectName() +"/dynamic/demo.jsp?albumId="+id+"&tpUrl="+tpUrl+"&musicUrl="+musicUrl, 'newwindow', 'height=760, width=510, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no')
			//iframe层
		/*	parent.layer.open({
			    type: 2,
			    closeBtn:1,
