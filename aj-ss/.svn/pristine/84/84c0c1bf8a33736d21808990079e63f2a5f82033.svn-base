...
.zp{position:absolute;z-index:11;text-align:center; width:100%;}
.zp img{ width:76%;}
.zp_big{position:absolute;z-index:11;text-align:center;top:180px; width:100%;display: none;}
.zp_big img{ width:100%;}
...
function setImage(idname)
{
    ...
    $("#div"+idname).bind("click",function(){
    		$("#zp_big").show();
    		$("#zhezhao").show();
			$("#zp_big_img").attr("src",Onload_imgs_url[image_url_index -1]);
...
function step_load()
{
    ...
    if(image_url_index  == 0 && bl_keepload == 'first')
    {
        ...
        console.info("load_num~"+slider_images_url.length);
