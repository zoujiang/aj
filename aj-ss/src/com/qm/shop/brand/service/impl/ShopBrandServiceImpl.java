...
public class ShopBrandServiceImpl  implements ShopBrandService{
	...
	public DataModel<Map<String, Object>> getList(ShopBrandVO limitKey) {
		...
		String sql = "select id, brand_name, sort_index, status, brand_icon from t_shop_brand where 1=1 ";
	...
	public int addBrand(String id, String brandName,
			Integer sortIndex, String brandIcon, Integer status) {
		
		String sql = "insert into t_shop_brand (id, brand_name, sort_index, status, brand_icon) values (?,?,?,?,?)";
		int i =	baseDAO.execteNativeBulk(sql, id, brandName, sortIndex, status, brandIcon);
		return i;
	}
	...
	public Map<String, Object> findBrandById(String id) {
		...
		String sql = "select id, brand_name, sort_index, status, brand_icon from t_shop_brand where id = ?";
	...
	public int updateBrand(String id, String brandName,
		...
		String sql = "update t_shop_brand set brand_name = ?, sort_index = ?, status = ?  ";
	...
	public List<Map<String, Object>> selectAll() {
		...
		String sql = "select id, brand_name, sort_index, status, brand_icon from t_shop_brand where status=0 order by sort_index ";
		return baseDAO.getGenericBySQL(sql, null);
	}

	@Override
	public List<Map<String, Object>> findByBrandName(String brandName) {
		
		String sql = "select id, brand_name, sort_index, status, brand_icon from t_shop_brand where brand_name = ? ";
		return baseDAO.getGenericBySQL(sql, new Object[]{brandName});
	}
