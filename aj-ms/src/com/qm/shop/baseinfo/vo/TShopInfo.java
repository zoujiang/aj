package com.qm.shop.baseinfo.vo;
...
public class TShopInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public TShopInfo(String id, String shopName, String idCard, String address, String shopCategoryId, String gps, String bankId, String bankCardNo, String tel, String bankCardName, Float percentage, String serviceBeginTime, String serviceEndTime, String logo, String showPic, String description, String createTime, Integer status, Integer zoneSize, String brandId, Integer isRecommend) {
        this.id = id;
        this.shopName = shopName;
        this.idCard = idCard;
	...
	@Column(name="zone_used")
	public Long getZoneUsed() {
		return zoneUsed;
	}

	public void setZoneUsed(Long zoneUsed) {
		this.zoneUsed = zoneUsed;
	}
