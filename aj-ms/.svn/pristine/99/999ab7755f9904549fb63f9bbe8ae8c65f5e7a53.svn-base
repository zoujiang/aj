...
public class ShopCustomerAction extends FtpImgDownUploadAction {
	...
	@ResponseBody
	public DataModel<Map<String, Object>> list(ShopCustomerVO limitKey,HttpServletRequest request) {
	...
	@ResponseBody
	public String add(ShopCustomerVO limitKey, HttpServletRequest request) {
		String shopId = (String) request.getSession().getAttribute(com.frame.core.constant.Constant.Login_USER_SHOP_ID);
		limitKey.setShopId(shopId);
	...
	@ResponseBody
	public String findByUserTel(String userTel, HttpServletRequest request) {
		String shopId = (String) request.getSession().getAttribute(com.frame.core.constant.Constant.Login_USER_SHOP_ID);
		JSONObject modelMap = new JSONObject();  
	...
	@ResponseBody
	public String all(String userTel, HttpServletRequest request) {
