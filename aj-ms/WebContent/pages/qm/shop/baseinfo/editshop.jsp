		...
		function AppMgr(){
		 ...
		 function initPageDatas(){
		 	 //初始化页面数据
				 $.ajax({
		             type: "GET",
		             url: "<%=path %>/admin/shop/baseinfo/find",
		             dataType: "json",
		             success: function(data){
		            	 if(data.success){
			            	...
			            	// $("#shopCategoryId").find("option[value='"+d.categoryId+"']").attr("selected",true);
			            	 $("#shopCategoryId").val(d.categoryId);
			            	 $("#shopCategoryName").val(d.categoryName);
                ...
                <div class="ibox-content row">
               	 	<form class="form-horizontal" id="userForm" action="<%=path %>/admin/shop/category/add" enctype="multipart/form-data" method="post">
               	 		...
               	 		<div class="row">
	               			<div class="form-group col-sm-6"> 
	               				...
	               				<div class="col-sm-8">
	               					<input type="text" readonly="readonly" class="form-control" name="shopName" id="shopName">  
	               				</div>
						    </div>
						    <div class="form-group col-sm-6" > 
                        ...
                        <div class="row">
	               			<div class="form-group col-sm-6"> 
	               				...
	               				<div class="col-sm-8">
	               					<input  type="hidden" name="shopCategoryId" id="shopCategoryId" class="form-control">
	               					<input  type="text"  id="shopCategoryName" class="form-control" readonly="readonly">
	               				</div>
						    </div>
						    <div class="form-group col-sm-6">
                        ...
                        <div class="row">
						    ...
						    <div class="form-group col-sm-6">
	                            ...
	                            <div class="col-sm-8">
	               					<input class="form-control" readonly="readonly" type="text" name="percentage" id="percentage">
	               				</div>
	                        </div>
                        </div>
                        <div class="row">
	               			<div class="form-group col-sm-6"> 
	               				...
	               				<div class="input-group m-b" style="padding-left: 15px;">
                                        ...
                                        <input type="text" class="form-control" name="cardNo" id="cardNo" style="width: 214px;">
                                    </div> </div>
						    <div class="form-group col-sm-6">
                        ...
                        <div class="row">
	               			<div class="form-group col-sm-6"> 
	               				...
	               				<div class="col-sm-8">
	               					...
	               					<input id="serviceBeginTime" readonly="readonly" class="laydate-icon form-control layer-date" placeholder="服务结束时间"  style="width: 291px;" name="serviceBeginTime" >
	               				</div>
						    </div>
						    <div class="form-group col-sm-6">
	                            ...
	                            <div class="col-sm-8">
	               					...
	               					<input id="serviceEndTime" readonly="readonly" class="laydate-icon form-control layer-date" placeholder="服务结束时间"  style="width: 291px;" name="serviceEndTime" >
	               				</div>
	                        </div>
                        </div>
                        <div class="row"  style="display: none;">
						    ...
						    <div class="form-group col-sm-6">
	                            ...
	                            <div class="col-sm-7">
	               					<input class="form-control" type="text" name="zoneSize" id="zoneSize">
                        ...
                        <div class="row">
						    <div class="form-group col-sm-6">
	                            <label class="col-sm-4 control-label">商户LOGO：</label>
