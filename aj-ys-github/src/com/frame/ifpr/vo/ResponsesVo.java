...
public class ResponsesVo implements Serializable{
	...
	public static final String SUCCESSUNBLIND="100008";
	...
	/** 响应参数封装VO*/
	private List<? extends ResultVo> result;
	...
	public List<? extends ResultVo> getResult() {
		return result;
	}

	public void setResult(List<? extends ResultVo> result) {
		this.result = result;
	}
}
