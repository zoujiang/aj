...
import com.frame.ifpr.vo.ResponsesVo;
...
public class BasePublishService implements PublishService {
	...
	public Object publishService(Object object) throws PublicException {
		...
		try {
			...
			}else if(target instanceof ResponsesVo){
				responsesVo = (ResponsesVo)target;
				responsesVo.setServiceName(requestVo.getServiceName());
				return interfaceAbility.processPublish(responsesVo);
			}else{
