...
<head>
    ...
    function AppMgr(){
		...
		AppMgr.freeze = function(id,valid,e){
			parent.layer.confirm('确定要'+valid==0?'启用':'冻结'+'品牌？', {
    		    btn: ['确定','取消'], //按钮
    		    shade: false //不显示遮罩
    		}, function(index){
    			parent.layer.close(index);
    			var url =  getProjectName() + "/admin/shop/brand/modifyState";
		...
		AppMgr.edit = function(id,valid,e){
			layer_show("编辑品牌", getProjectName() +"/pages/qm/shop/brand/edit.jsp?id="+id,"800","420");
		}
		AppMgr.add = function(e){
    		layer_show("添加品牌", getProjectName() +"/pages/qm/shop/brand/add.jsp","800","420");
		};
    	this.initDatas = function(){
    	
			 $table.bootstrapTable({
    			url: getProjectName() + "/admin/shop/brand/list",
                showExport:false,
                toolbar:'#toolbar',
