...
<head>
    ...
    function AppMgr(){
		...
		AppMgr.edit = function(id,valid,e){
			layer_show("编辑商户帐号", getProjectName() +"/pages/qm/shop/account/editaccount.jsp?id="+id,"800","400");
		}
		AppMgr.add = function(e){
    		layer_show("添加商户帐号", getProjectName() +"/pages/qm/shop/account/addaccount.jsp","800","400");
		};
    	this.initDatas = function(){
    	
			 $table.bootstrapTable({
    			url: getProjectName() + "/admin/shop/account/list",
                showExport:false,
                toolbar:'#toolbar',
