                ...
                <div class="ibox-content row">
						...
						<div class="row" id="pic1">
							<div class="form-group col-sm-6">
								...
								<div class="col-sm-8">
									<input type="file" id="tsmpPic" name="showPicsImg" multiple="multiple"  accept="image/*" class="form-control"/> 
								</div>
							</div>
							<div class="form-group col-sm-6">
								<div class="col-sm-12" style="margin-left: -20px;margin-top: 8px;">
									<span id="viewShowPic"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 6px;color: lightgray;">支持同时选择多张jpg,png图片，建议尺寸1500x960，大小100k以内</span>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<div class="col-sm-12" style="margin-left: -20px;margin-top: 8px;">
									 <span id="viewLogo"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 6px;color: lightgray;">支持jpg,png图片，建议尺寸220x164，大小50k以内</span>
								</div>
							</div>
						</div>
						 <div class="row">
