...
public class ShopCommentListService implements PublishService{
	...
	public Object publishService(Object obj) throws PublicException {
		...
		String sql = "SELECT u.id cmtUserId, u.PHOTO cmtUserPhoto, u.NICK_NAME cmtUserNickName, c.cmt_content cmtContent, c.cmt_img cmtImgUrl, c.score cmtScore, c.cmt_time cmtDate FROM t_shop_comment c, t_user u WHERE c.cmt_user_id = u.ID AND c.cmt_shop_id = ? AND c.status = 0 ORDER BY c.cmt_time DESC";
