...
@Service("easemobGroupMembsDel")
public class DelEasemobGroupMembsService implements PublishService {

	@Autowired EasemobGroupService easemobGroupService;

	private Logger log = Logger.getLogger(DelEasemobGroupMembsService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		try {
			JSONObject object = easemobGroupService.delGroupMembs(params);
			log.info(object.toString());
			if(object.get("statusCode") != null && "200".equals(object.get("statusCode").toString())){
				result.put("succMsg", "移除环信群组成员成功！");	
				...
				if(msg != null && !"".equals(msg)){
					...
					returnJSON.put("errorMsg", "移除环信群组成员失败！");
				}
