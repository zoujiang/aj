...
import com.aj.easemob.vo.Token;
...
public class HTTPClientUtils {
	 ...
	 * @return
	 */
	public static JSONObject sendHTTPRequest(URL url, Credential credential, Object dataBody, String method) {
	 ...
	 * @return
	 */
	public static JSONObject uploadFile(URL url, File file, Credential credential, List<NameValuePair> headers)
