 	...
 	<script type="text/javascript">
 		function ActMgr(){
 			...
 			ActMgr.add = function(e){
 				var area=new Object();
 				area.editType="add";                                                       
 				com.eason.window.winUtils.showDialogWindowOfWH(700,500,e,mainWeb + "/pages/msg/msgAdd.jsp",area,function(returnValue){
 			...
 			ActMgr.modify = function(id,e){
 				...
 				actMgrVo.apr="0";
 				com.eason.window.winUtils.showDialogWindowOfWH(700,500,e,mainWeb + "/pages/msg/msgEdit.jsp",actMgrVo,function(returnValue){
 					if("success"==returnValue){
	                	$table.datagrid('reload');
               		}
 				});
 			...
 			this.initTable = function(){
	 			$table.datagrid({
					...
					pagination: true,
					singleSelect: true,
					url:mainWeb + "/admin/push/message/getMessage",
				    columns:[[  
