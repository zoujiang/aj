...
@Service("easemobFriendGet")
public class GetEasemobFriendService implements PublishService {
	
	@Autowired EasemobUserService easemobUserService;

	private Logger log = Logger.getLogger(GetEasemobFriendService.class);
		...
		try {
			...
			if(object.get("statusCode") != null && "200".equals(object.get("statusCode").toString())){
				...
				if(msg != null && !"".equals(msg)){
					...
					returnJSON.put("errorMsg", "获取好友失败！");
				}
