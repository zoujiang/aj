...
public final class FtpUtils {
	...
	public static void main(String[] args) throws IOException {
		FileInputStream fis=new FileInputStream("D:/360Downloads/test.txt");
		FTPClient ftp=FtpUtils.getFtpClient("192.168.1.197", 21, "ams", "ams123!@#");
		FtpUtils.uploadFile(ftp, "upload/wod", "lishun.txt", fis);
		String filename="李顺";
