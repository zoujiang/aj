...
@Service("kindergartenPhotoDig")
public class KindergartenPhotoDigService implements PublishService{

	private Logger log = Logger.getLogger(KindergartenPhotoDigService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		TKindergartenPhoto photo = baseDAO.get(TKindergartenPhoto.class, Integer.parseInt(photoId));
		if(photo == null){
			returnJSON.put("returnCode", Constant.RETURNCODE_FAILED);
			returnJSON.put("result", result);
