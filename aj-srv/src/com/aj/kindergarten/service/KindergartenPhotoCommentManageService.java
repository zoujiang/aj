...
import com.aj.kindergarten.vo.TKindergartenPhotoComment;
...
@Service("kindergartenPhotoCmtMgr")
public class KindergartenPhotoCommentManageService implements PublishService{

	private Logger log = Logger.getLogger(KindergartenPhotoCommentManageService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		if("1".equals(oper)){
			TKindergartenPhotoComment cmt = new TKindergartenPhotoComment();
			...
			if(replyCmtId == null || "".equals(replyCmtId)){
				...
				cmt.setIsReply(0);
				//根据评论ID查询评论USERID
				String hsql = "from TKindergartenPhotoComment where id = ?";
				List<TKindergartenPhotoComment> quCmtList = baseDAO.getGenericByHql(hsql, Integer.parseInt(replyCmtId));
			...
			TKindergartenPhoto photo = baseDAO.get(TKindergartenPhoto.class, Integer.parseInt(cmtTarget) );
			photo.setCommentNum(photo.getCommentNum() == null ? 1 : photo.getCommentNum()+1);
