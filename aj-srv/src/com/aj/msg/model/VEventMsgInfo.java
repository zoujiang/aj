 ...
 */
@Entity
@Table(name = "v_event_mgs_info")
public class VEventMsgInfo implements java.io.Serializable {
	...
	/** default constructor */
	public VEventMsgInfo() {
	}

	/** minimal constructor */
	public VEventMsgInfo(String msgId) {
		this.msgId = msgId;
	}

	/** full constructor */
	public VEventMsgInfo(String msgId, String msgFrom, String msgType,
