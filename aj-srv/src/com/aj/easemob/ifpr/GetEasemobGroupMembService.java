...
@Service("easemobGroupMembsGet")
public class GetEasemobGroupMembService implements PublishService {

	@Autowired EasemobGroupService easemobGroupService;

	private Logger log = Logger.getLogger(GetEasemobGroupMembService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		try {
			JSONObject object = easemobGroupService.getGroupMembs(params);
			log.info(object.toString());
			if(object.get("statusCode") != null && "200".equals(object.get("statusCode").toString())){
				JSONArray array = object.getJSONArray("data");
				result.put("succMsg", "获取群组成员成功！");	
				...
				if(msg != null && !"".equals(msg)){
					...
					returnJSON.put("errorMsg", "获取群组成员失败！");
				}
