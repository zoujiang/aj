...
@Service("easemobNickMod")
public class ModEasemobNickService implements PublishService {
	...
	public Object publishService(Object obj) throws PublicException {
		...
		if(params.optString("nickname") == null || "".equals(params.optString("nickname"))){
			returnJSON.put("returnCode", Constant.RETURNCODE_FAILED);
			returnJSON.put("result", result);
			returnJSON.put("errorMsg", "环信昵称不能为空！");
			return returnJSON.toString();
		}
		try {
			JSONObject object = easemobUserService.modNick(params);
			log.info(object.toString());
			if(object.get("statusCode") != null && "200".equals(object.get("statusCode").toString())){
				JSONArray array = object.getJSONArray("entities");
				result.put("succMsg", "修改环信昵称成功！");	
				...
				if(object.get("statusCode") != null){
					...
					returnJSON.put("errorMsg", "修改环信昵称失败！");
				}
				return returnJSON.toString();
			}
