...
@Service("easemobJoinedGroupGet")
public class GetEasemobJoindGroupService implements PublishService {

	@Autowired EasemobGroupService easemobGroupService;

	private Logger log = Logger.getLogger(GetEasemobJoindGroupService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		try {
			JSONObject object = easemobGroupService.getJoinedGroup(params);
			log.info(object.toString());
			if(object.get("statusCode") != null && "200".equals(object.get("statusCode").toString())){
				JSONArray array = object.getJSONArray("data");
				result.put("succMsg", "获取参与的群组成功！");	
				...
				if(msg != null && !"".equals(msg)){
					...
					returnJSON.put("errorMsg", "获取参与的群组失败！");
				}
