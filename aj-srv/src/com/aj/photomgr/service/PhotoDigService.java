...
@Service("photoDig")
public class PhotoDigService implements PublishService{

	private Logger log = Logger.getLogger(PhotoDigService.class);
	...
	public Object publishService(Object obj) throws PublicException {
		...
		String hsql = "from TPhoto where id = ?";
		List<TPhoto> photoList = baseDAO.getGenericByHql(hsql, photoId);
