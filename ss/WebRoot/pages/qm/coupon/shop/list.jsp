...
<head>
    ...
    function AppMgr(){
		...
		AppMgr.freeze = function(id,valid,e){
			parent.layer.confirm('确定要'+valid==0?'启用':'冻结'+'优惠券商家？', {
    		    btn: ['确定','取消'], //按钮
    		    shade: false //不显示遮罩
    		}, function(index){
    			parent.layer.close(index);
    			var url =  getProjectName() + "/admin/coupon/shop/modifyState";
		...
		AppMgr.edit = function(id,valid,e){
			layer_show("编辑优惠券商家", getProjectName() +"/pages/qm/coupon/shop/edit.jsp?id="+id,"800","520");
		}
		AppMgr.exp = function(id,valid,e){
			 ...
			 $.ajax({
	             type: "POST",
	             url: getProjectName()+"/admin/coupon/shop/export",
	             data:shopName,
	             dataType: "json",
		...
		AppMgr.add = function(e){
    		layer_show("新建优惠券商家", getProjectName() +"/pages/qm/coupon/shop/add.jsp","800","520");
		...
		/* parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['800px', '90%'],
		    content:  getProjectName() +"/pages/qm/coupon/shop/add.jsp" //iframe的url
		}); */
    	...
    	this.initDatas = function(){
			 ...
			 $table.bootstrapTable({
    			url: getProjectName() + "/admin/coupon/shop/list",
                showExport:false,
                toolbar:'#toolbar',
            ...
            <div class="ibox-content"  style="height: 100%;">
            	<div class="btn-group hidden-xs" id="toolbar" role="group" style="margin-top: 10px;">
                    <div class="form-inline" style="width: 480px;float: left;">
                    	 店铺名称：<input type="text" placeholder="店铺名称" class="form-control input-inline"  id="name" name="name" width="280px">
