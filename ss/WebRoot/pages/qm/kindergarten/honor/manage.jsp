	...
	<script type="text/javascript">
	 ...
	 function AppMgr(){
		 ...
		 this.initDatas = function(){
			 ...
			 $.ajax({
	             type: "GET",
	             url: "<%=path %>/admin/kindergarten/honor/init",
	 ...
	 function deleteFile(pId){
		 layer.confirm('确定删除文件?删除后将不能恢复！', {icon: 3, title:'警告'}, function(index){
			  ...
			  $.ajax({
		             type: "GET",
		             url: "<%=path %>/admin/kindergarten/honor/deleteFile",
		             data: "id="+pId,
		             dataType: "json",
		             success: function(data){
		                  if(data.success){
	 ...
	 function alterPhotoName(){
		 ...
		 if(pId != null && pId != '' && pName != null && pName != ''){
			 if(pName.length > 40){
				 ...
				 $.ajax({
		             type: "GET",
		             url: "<%=path %>/admin/kindergarten/honor/alterPhotoName",
                ...
                <div class="row">
                        ...
                        <form role="form">
                            <div class="form-group">
                                ...
                                <input type="text" id="photoName" placeholder="请输入荣誉名称" class="form-control">
                            </div>
                            <div>
