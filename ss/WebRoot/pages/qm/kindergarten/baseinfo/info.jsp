								 ...
								 $.ajax({
						             ...
						             success: function(data){
						            	 if(data.success){
							            	 ...
							            	 $("#shopCategoryId").find("option[value='"+d.shopCategoryId+"']").prop("selected",true);
							            	 $("#properties").find("option[value='"+d.properties+"']").prop("selected",true);
							            	 $("#brandId").find("option[value='"+d.brandId+"']").prop("selected",true);
							            	 $("#category").find("option[value='"+d.category+"']").prop("selected",true);
