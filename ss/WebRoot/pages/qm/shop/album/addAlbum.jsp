    			...
    			<form class="form-horizontal" id="userForm" method="post">
	               	 <div class="row">
		               	<div class="form-group col-sm-6"> 
		               		...
		               		<div class="col-sm-8">
		               			<select class="form-control col-sm-12" name="shopId" id="shopId" onchange="clearCustomerUserTel();" >
								 </select>
		               		</div>
						</div>
						<div class="form-group col-sm-6"> 
               	 	...
               	 	<div class="row">
						    ...
						    <div class="form-group col-sm-6"> 
	               				<label class="col-sm-4 control-label" >原价：<span style="font-size: 3mm ;font-weight: normal;">(单位：元)<br/>(支持2位小数)</span></label> 
	               				<div class="col-sm-8">
	               					<input type="text" class="form-control" name="origPrice" id="orgPrice" readonly="readonly"> 
	               				</div>
						    </div>
                        </div>
	               	...
	               	<div class="row">
	               			<div class="form-group col-sm-12"> 
	               				...
	               				<div class="col-sm-3">
	               					<span style="float: left;text-align: center;line-height: 35px;">三个月：</span><input type="text" class="form-control" name="payType_3" id="payType_3" style="width: 100px;" readonly="readonly"> 
	               				</div>
	               				<div class="col-sm-3">
	               					<span style="float: left;text-align: center;line-height: 35px;">六个月：</span><input type="text" class="form-control" name="payType_6" id="payType_6" style="width: 100px;" readonly="readonly"> 
	               				</div>
	               				<div class="col-sm-3">
	               					<span style="float: left;text-align: center;line-height: 35px;">九个月：</span><input type="text" class="form-control" name="payType_9" id="payType_9" style="width: 100px;" readonly="readonly"> 
	               				</div>
						    </div>
                    </div>		
	                <div class="row">
	               			<div class="form-group col-sm-12"> 
	               				...
	               				<div class="col-sm-3">
	               					<span style="float: left;text-align: center;line-height: 35px;">两&nbsp;&nbsp;&nbsp;年：</span><input type="text" class="form-control" name="payType_24" id="payType_24" style="width: 100px;" readonly="readonly"> 
	               				</div>
	               				<div class="col-sm-3">
	               					<span style="float: left;text-align: center;line-height: 35px;">两年后：</span><input type="text" class="form-control" name="payType_25" id="payType_25" style="width: 100px;" readonly="readonly"> 
	               				</div>
						    </div>
                   </div>		
				   <div class="row">
