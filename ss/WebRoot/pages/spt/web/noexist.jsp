...
<section id="main">
    ...
    <div class="wy-main03">
        ...
        <!-- 信息部分  改变 报名信息不存在-->
        <div class="wy-information">
            <div class="wy-information-no">
                <h3>系统提示</h3>
                <p class="wy-beijing"><span>报名信息不存在</span></p>
                <p class="wy-fanhui"><a onclick="javascript:history.go(-1);"><img src="images/wy-mls04.gif" alt=""/></a></p>
            </div>
        </div>
