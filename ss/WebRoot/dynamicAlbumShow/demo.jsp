...
#shangxin3{
    ...
    left: 175px;
    -webkit-transform: scale(0.4);
    -webkit-animation:xinshan1 3s 0.5s alternate linear infinite both;
}
#shangxin4{
    top: -80px;
    left: 270px;
...
#huaban{
    ...
    -webkit-transform:rotateX(75deg) rotateY(2.5deg) scale(0.6);
...
{
    from{-webkit-transform:translate(0px,0px) rotate(0deg) scale(0.5);}
    to{-webkit-transform:translate(150px,900px) rotate(270deg) scale(0.5);}
}
@-webkit-keyframes huaban
{
    0%{-webkit-transform:translate(-100px,-1000px) rotateX(-400deg) rotateY(2.5deg) scale(0.6)}
    50%{-webkit-transform:translate(0px,0px) rotateX(75deg) rotateY(2.5deg) scale(0.6);  -webkit-animation-timing-function: ease-out;}
    100%{-webkit-transform:translate(600px,0px) rotateX(75deg) rotateY(2.5deg) scale(0.6)}
}
...
#lovedian{
    top: 556px;
    left: -4px;
    -webkit-animation:lovedianfade 0.5s alternate infinite linear both;
}
#lovedian1{
    top: 556px;
    left: -4px;
    -webkit-animation:lovedianfade 0.5s 0.5s alternate infinite linear both;
}
...
#bgxin
{
    top: 188px;
    left: 325px;
    -webkit-animation:bgxin 1.2s 0.4s alternate infinite linear both;
}
...
<div id='container'>
    <img src='https://qnphoto.kagirl.cn/pic/qingren17/bg.jpg'>

     <div id='pagetitle'>
        <img id='titlebg' src='https://qnphoto.kagirl.cn/pic/qingren17/titlebg.png'>
        <img id='tbgxin0' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin1' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin2' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin3' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin4' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin5' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin6' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin7' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin8' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin9' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin10' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin11' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin12' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin13' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
        <img id='tbgxin14' src='https://qnphoto.kagirl.cn/pic/qingren17/guang031.png'>
