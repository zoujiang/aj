...
public class LeTVCloudClient {	    
	    private String userUnique = SystemConfig.getValue("letv.user.unique");
	    private String secretKey = SystemConfig.getValue("letv.secret.key");;
		...
		public LeTVCloudClient(String userUnique, String secretKey) {
	        this.userUnique = userUnique;
	        this.secretKey = secretKey;
	    }
		
		public LeTVCloudClient() {
	       // this.userUnique = userUnique;
	       // this.secretKey = secretKey;
	    }
		...
		public String doUploadFile(File file, String url) throws IOException{
		        ...
		        FilePart fp = new FilePart("filedata", file);  
		            ...
		            client.getHttpConnectionManager().getParams().setConnectionTimeout(5000000);// 设置连接时间  
